...
extension SRCountryPickerController: UITableViewDataSource, UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = MuliFontBook.Regular.of(size: 14)
        cell.detailTextLabel?.font = MuliFontBook.Regular.of(size: 14)
