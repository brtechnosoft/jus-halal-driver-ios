...
open class LinearProgressBar: UIView {
    ...
    open var linearBarWidth: CGFloat = 0
    ...
    fileprivate func configureAnimation() {
        ...
        UIView.animateKeyframes(withDuration: 1.0, delay: 0, options: [], animations: {
            ...
            UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.5, animations: {
                self.progressBarIndicator.frame = CGRect(x: 0, y: 0, width: self.widthForLinearBar*0.6, height: self.heightForLinearBar)
            })
            
//            UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.5, animations: {
//                self.progressBarIndicator.frame = CGRect(x: 0, y: 0, width: self.linearBarWidth, height: self.heightForLinearBar)
//            })
